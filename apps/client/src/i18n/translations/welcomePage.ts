...
const welcomePage = {
  ...
  [Language.RU]: {
    ...
    [TranslationKeys.WELCOME_DESCRIPTION]: `Тренируйся. Отвечай. Побеждай.
      Мультилеерная игра для подготовки к техническим собеседованиям. Угадывай JS/TS концепты, подтверждай знания и становись сильнее. Один в поле не воин – объединяйся с джедаями кода или тренируйся с ИИ-капитаном.`,
  },
};
